...
class MyProjects extends Component {
    ...
    checkAppliedUsers=id=>{
        this.props.history.push('/applied-users/'+id);
    }
			...
			return (
				<Grid key={project._id} item sm={10} md={4}>
					<DataCard
                        ...
                        numApplied={project.appliedBy.length}
                        checkApplied={this.checkAppliedUsers}
					/>
				</Grid>
			);
		});
